...
- Application source code (paths per `project/PROJECT-INFRASTRUCTURE.md`)
- Deploy scripts (`deploy/`)
- Instruction templates (`instructions/`, pack `HELMSMAN-AGENT.md` inside `helmsman-agent/`)
- Project workflow files (`project/PROJECT-OVERVIEW.md`, `project/PROJECT-INFRASTRUCTURE.md`, `project/histories/`, etc.)
