...
Ensure your agent tool loads **`{root}/AGENTS.md`** (required when `helmsman-agent/` exists), and that agents follow **[`helmsman-agent/HELMSMAN-AGENT.md`](helmsman-agent/HELMSMAN-AGENT.md)** and **[`helmsman-agent/instructions/RULES.md`](helmsman-agent/instructions/RULES.md)** for the full workflow (gates A–F, plans, tasks, code rules).
...
- Sanity check is internal Markdown link validity. Links into `helmsman-agent/project/` (e.g.
  `project/PROJECT-OVERVIEW.md`, `project/PROJECT-INFRASTRUCTURE.md`, `project/PROJECT-DESIGN.md`, `project/design/`, `project/documents/`) are **expected to be
