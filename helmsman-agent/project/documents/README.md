...
For UI depth (tokens, components, screens), see [`project/design/`](../design/). Platform inventory lives in [`project/plans/`](../plans/) and `project/PROJECT-INFRASTRUCTURE.md`.
