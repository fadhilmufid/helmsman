...
The **index** (philosophy, library choice, links) lives in `project/PROJECT-DESIGN.md` (gitignored). All token, component, and screen detail lives here in `project/design/`.
