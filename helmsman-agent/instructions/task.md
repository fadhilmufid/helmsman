...
Related: [`rules.md`](rules.md), [`plan.md`](plan.md), [`../helmsman-agent.md`](../helmsman-agent.md), [`infrastructure.md`](infrastructure.md), [`history.md`](history.md), [`document.md`](document.md), [`code.md`](code.md), [`design.md`](design.md), [`greenfield.md`](greenfield.md), [`brownfield.md`](brownfield.md).
...
- **Ask when blocked** — one batch with **Recommended:** default per [`helmsman-agent.md`](../helmsman-agent.md) section 3
